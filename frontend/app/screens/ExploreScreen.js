...
export default function ExploreScreen({ finishedBooks, fetchAllBooks }) {
  ...
  const renderGenreItem = ({ item }) => (
    <TouchableOpacity
      style={[
        styles.filterChip,
        activeGenre === item && styles.activeFilterChip,
      ]}
      onPress={() => {
        setActiveGenre(item);
        handleSearch();
    ...
    >
      <Text
        style={[
          ...
          activeGenre === item && styles.activeFilterChipText,
        ]}
      >
        {item}
      </Text>
  ...
  const renderRatingItem = ({ item }) => (
    <TouchableOpacity
      style={[
        styles.filterChip,
        activeRating === item && styles.activeFilterChip,
      ]}
      onPress={() => {
    ...
    >
      <Text
        style={[
          styles.filterChipText,
          activeRating === item && styles.activeFilterChipText,
        ]}
      >
        {item}
      </Text>
  ...
  const renderBookItem = ({ item }) => (
    ...
    >
      ...
      <View
        style={
          viewMode === "grid" ? styles.gridBookContent : styles.listBookContent
        }
      >
          ...
          <View style={styles.viewModeContainer}>
            ...
            >
              <MaterialIcons
                name="grid-view"
                size={24}
                color={viewMode === "grid" ? "#6200ee" : "#757575"}
              />
            </TouchableOpacity>
            <TouchableOpacity
              style={[
            ...
            >
              <MaterialIcons
                name="view-list"
                size={24}
                color={viewMode === "list" ? "#6200ee" : "#757575"}
              />
            </TouchableOpacity>
          </View>
        </View>
